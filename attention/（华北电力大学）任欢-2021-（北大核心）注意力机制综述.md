...
（总结：1.信息量大 ，包括了有用的信息、没用的信息。  2.人脑有意、无意对信息进行筛选。）
...
![image-20230211153349153](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230211153349153.png)
...
![image-20230213165933595](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230213165933595.png)

以上图为例，我想知道一句话中，和making的词性相同的有哪些？可以把making和句子中的其他单词进行分析比较，得出它们之间的相关性。
...
![image-20230213170331666](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230213170331666.png)

在自注意力机制中，Q、K、V来源于同一个X，通过不同的参数矩阵W得来。



2.Q与K相作用（与注意力机制相似），做点积的原因：

在向量中,**<font color='red'>AB点乘的结果反应了他们之间的相似度, (A在B上的投影与B的模相乘得到的结果)</font>**
如果`AB`是垂直的，那么它们的点积是`0`，即它们的相似度是`0`
因此，`AB`点积的结果越大，说明两个向量的相似度越高。

![image-20230213170850292](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230213170850292.png)



3.Scale+Softmax

![image-20230213170924826](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230213170924826.png)



4.A与V相作用，得到新的V（这里是Z，表示自身与其他词向量的相关性）

![image-20230213171200048](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230213171200048.png)



**<font color='red'>问题：如何理解这里的Z1、Z2？</font>**

![image-20230214170718497](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230214170718497.png)



Z就是下面的B，B是X（input）新的一种表示方式。如x1是machine，则z1就表明machine，且其他单词与machine的相关性。从下面的计算来看，首先我们要清楚，a11、a12、a13是什么？（它们表示了词向量间的关联性），b怎么来的？（累加，a与v做点乘。则谁的attention score大，b与谁的相似度就高一点。）

![image-20230214170519204](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230214170519204.png)

**<font color='red'>通俗理解</font>**

**核心公式：**

![image-20230214172647149](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230214172647149.png)

Q、K、V：

![image-20230214172715586](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230214172715586.png)

![image-20230214172808652](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230214172808652.png)

![image-20230214172822674](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230214172822674.png)

### Multi-Head Self-attention

**<font color='red'>VS Self-attention</font>**

输入向量，多个不同的映射矩阵Wqn、Wkn、Wvn，**计算多个attention**，组合起来。

![image-20230216111311308](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230216111311308.png)

### Positional Encoding

**<font color='red'>在计算attention过程中，</font>**没有考虑向量间的位置信息（距离一样，一视同仁）。

通过Positional Encoding引入**位置信息（空间、时序）**

![image-20230216111937826](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230216111937826.png)
...
![image-20230215200455782](C:\Users\admin\AppData\Roaming\Typora\typora-user-images\image-20230215200455782.png)

## 概述

一个sequence2sequence模型，给定一个序列，输出另一个序列。常见的应用有：机器翻译等等。

Transformer以encoder-decoder为整体架构。
